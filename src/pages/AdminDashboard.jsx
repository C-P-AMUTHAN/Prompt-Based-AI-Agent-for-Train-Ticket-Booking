...
const AdminDashboard = () => {
  ...
  const handleAddTrain = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        setNotification({ isOpen: true, title: 'Success', message: 'Train added successfully!', type: 'success' });
        setTrain({
          name: "",
          number: "",
          from: "",
        ...
        setNotification({ isOpen: true, title: 'Error', message: data.message || "Failed to add train", type: 'error' });
      }
    } catch (err) {
      setNotification({ isOpen: true, title: 'Error', message: 'Error adding train', type: 'error' });
    }
  };

  return (
    <div className="home-container admin-dashboard">
      <motion.header
