/**
 * Prettify utility class
 * Parses erail.in API responses and converts them to JSON
 */
...
class Prettify {
  ...
  /**
   * Parse live station data using cheerio
   */
  LiveStation($) {
    try {
      let arr = [];
